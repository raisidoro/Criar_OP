...
##############################################
    ...
    def SetorColetor(codigo):
        ...
        print(local + "|")
        if local == 'WS-TPV' or local == 'WS-GR':
            sControl = True
        else:
            sControl = False
    ...
    def inicializaKanban(kanban, PartNumber, verificaKanban, maquina):
        ...
        if(verificaKanban):
            ...
            setor = str(tabAp['CI'+str(k)].value).upper()
    ...
    for k in range(12,tabAp.max_row+1):
        ...
        if(str(tabAp['CC'+str(k)].value) != "None"):
            setorDest = ''
            coletaCod = ''
            kanban = ''
            setorOrigem = ''
            ...
            qtdMovimentacao = float(tabAp['CC'+str(k)].value)

            if(str(tabAp['CA'+str(k)].value) != "None"):
                coletaCod = str(tabAp['CA'+str(k)].value).upper()
            else:
            ...
            tipoMovimentacao = str(tabAp['CE'+str(k)].value)
            ...
            if(str(tabAp['CG'+str(k)].value) != "None"):
                coletaDest = str(tabAp['CG'+str(k)].value).upper()
            ...
            if(indSenbetsu):
                ...
                coletaOrigem = str(tabAp['CI'+str(k)].value).upper()     
